...
<script type="text/javascript">
	...
	function searchStudent() {
		$('#dg').datagrid('load', {
			...
			facultyId : $('#s_facultyId').combobox("getValue"),
			gradeId : $('#s_gradeId').combobox("getValue"),
			dormitoryId : $('#s_dormitoryId').combobox("getValue")
		});
	}
	...
	function saveStudent() {
		$("#fm").form("submit", {
			...
			onSubmit : function() {
				...
				if ($('#facultyId').combobox("getValue") == "") {
				...
				if ($('#dormitoryId').combobox("getValue") == "") {
					$.messager.alert("系统提示", "请选择所属公寓");
					return false;
				}
	...
	function resetValue() {
		...
		$("#facultyId").combobox("setValue", "");
		$("#gradeId").combobox("setValue", "");
		$("#dormitoryId").combobox("setValue", "");
		$("#email").val("");
		$("#stuDesc").val("");
	}
	...
	<table id="dg" title="学生信息" class="easyui-datagrid" fitColumns="true"
		...
		<thead>
			<tr>
				...
				<th field="facultyId" width="100" align="center">学院id</th>
				<th field="gradeId" width="100" align="center">班级ID</th>
				<th field="dormitoryId" width="100" align="center">宿舍ID</th>
	...
	<div id="tb">
		...
		<div>
			&nbsp;学号：&nbsp;<input type="text" name="s_stuNo" id="s_stuNo"
				...
				editable="false" size="10" /> &nbsp;所属学院：&nbsp;<input
				class="easyui-combobox" id="s_facultyId" name="s_facultyId"
				size="10"
				data-options="panelHeight:'auto',editable:false,valueField:'id',textField:'facultyName',url:'facultyComboList'" />
			...
			&nbsp;所属宿舍：&nbsp;<input class="easyui-combobox" id="s_dormitoryId"
				name="s_dormitoryId" size="10"
				data-options="panelHeight:'auto',editable:false,valueField:'id',textField:'dormitoryName',url:'dormitoryComboList'" />
	...
	<div id="dlg" class="easyui-dialog"
		...
		<form id="fm" method="post">
			<table cellspacing="5px;">
				...
				<tr>
					<td>学院名称：</td>
					<td><input class="easyui-combobox" id="facultyId"
						name="facultyId"
						data-options="panelHeight:'auto',editable:false,valueField:'id',textField:'facultyName',url:'facultyComboList'" /></td>
					<td></td>
					<td>班级名称：</td>
					...
					<td></td>
					<td>宿舍名称：</td>
					<td><input class="easyui-combobox" id="dormitoryId"
						name="dormitoryId"
						data-options="panelHeight:'auto',editable:false,valueField:'id',textField:'dormitoryName',url:'dormitoryComboList'" /></td>
					<td></td>
					<td>Email：</td>
